...
class VerifyObjectState(smach.State):
    ...
    def __init__(self, room_name):
        smach.State.__init__(self, outcomes=['found', 'not_found', 'preempted'], input_keys=['object_to_find'], output_keys=['found_room'])
    ...
    def spin_robot_thread(self):
        ...
        rate = rospy.Rate(10)
        while self.spinning and not rospy.is_shutdown():
